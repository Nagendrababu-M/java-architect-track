# Phase 3 — System Design: LLD + HLD (Weeks 8–14, Days 51–105)
...
## Week 8 — LLD Foundations: OO, UML, SOLID & Core Patterns (Days 51–57)

### Day 51 — Object-Oriented Design Principles Revisited
...
### Day 52 — UML Diagrams for Software Architects: Class, Sequence, Component & ER
- **Core concepts:**
...
### Day 53 — SOLID Principles (SRP, OCP, LSP, ISP, DIP)
- **Core concepts:**
...
### Day 54 — Creational Patterns: Singleton, Factory, Builder
...
### Day 55 — Structural Patterns: Adapter, Decorator, Facade, Proxy
...
### Day 56 — Behavioral Patterns: Strategy, Observer, Command, State
...
### Day 57 — Week 8 Synthesis: Refactor a Real Codebase
- **Format:** Take messy code, refactor using 2-3 GoF patterns
- **Deliverable:** Before/after with pattern justification

---

## Week 9 — LLD Practice: Real Designs (Days 58–64)

### Day 58 — Design a Parking Lot
...
### Day 59 — Design a Rate Limiter (LLD)
...
### Day 61 — Design a Logger / Notification System
...
### Day 64 — Week 9 Synthesis: Mock LLD Interview
...
## Week 10 — HLD Theory: CAP, Consistency, Load Balancing (Days 65–72)

### Day 65 — CAP Theorem (and Why It's Overhyped)
...
### Day 66 — PACELC Theorem & Consistency Models
...
### Day 67 — Load Balancing Strategies
...
### Day 68 — Consistent Hashing Deep Dive
...
### Day 71 — Redis Deep Dive: Sorted Sets, Cluster, Sentinel & Lua
- **Core concepts:**
...
### Day 72 — Week 10 Synthesis: Cache + LB Decision Matrix
- **Deliverable:** For 5 different read/write workloads, choose caching strategy + LB strategy + justify

---

## Week 11 — Storage: SQL, NoSQL, Normalization & Sharding (Days 73–81)

### Day 73 — Relational Database Internals
...
### Day 74 — Database Normalization: 1NF to BCNF, Denormalization & Practical Trade-offs
- **Core concepts:**
...
### Day 75 — SQL Sharding & Replication
...
### Day 77 — DynamoDB Design Patterns
...
### Day 79 — Database Selection Framework
...
### Day 80 — Week 11 Synthesis: Schema Design Exercise
...
### Day 81 — Distributed Locking + Distributed ID Generation
- **Core concepts:**
...
### Day 82 — Messaging Patterns: Queue vs Pub/Sub
...
### Day 83 — Kafka: Internals & Consumer Groups
- **Core concepts:**
...
### Day 84 — Exactly-Once Semantics & Idempotency
...
### Day 86 — Transactional Outbox Pattern + CQRS Deep Dive
- **Core concepts:**
...
### Day 87 — Stream Processing: Kafka Streams, Flink (intro)
...
### Day 88 — Week 12 Synthesis: Design an Event-Driven Order System
...
### Day 89 — Monolith vs Microservices: The Real Trade-offs
...
### Day 90 — Service Decomposition: DDD, Bounded Contexts
...
### Day 91 — Database per Service + Strangler Fig + Anti-Corruption Layer
- **Core concepts:**
...
### Day 92 — Distributed Transactions: Saga Pattern
...
### Day 93 — REST API Design + gRPC + WebSockets
- **Core concepts:**
...
### Day 94 — API Gateway, BFF, Service Mesh
...
### Day 95 — Service Discovery & Health Checks
...
### Day 96 — OAuth2 / JWT / Spring Security — Auth Architecture
- **Core concepts:**
...
### Day 97 — Resilience Patterns: Circuit Breaker, Bulkhead, Timeout, Retry
...
### Day 98 — Week 13 Synthesis: Design a Microservices Migration
...
### Day 101 — Design Uber / Ride-Hailing
...
### Day 102 — Design WhatsApp / Messaging
...
### Day 103 — Design YouTube / Video Streaming
...
### Day 104 — Design a Distributed Cache (like Redis)
...
### Day 105 — Phase 3 Synthesis: Full Mock System Design Interview
